...
0. Test your design with assistive technology, such as a screen reader, VoiceOver on iOS is recommended, does the feature make sense? If using VoiceOver for the 1st time, see the [Assistive Technology Setup Guide](assistive-technology-set-up-guide).
